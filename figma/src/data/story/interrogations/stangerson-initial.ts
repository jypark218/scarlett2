 ...
 * 첫 대면 및 기본 질문
 * 
 * ⚠️ 파일 크기 최적화: 7개 노드만 포함 (나머지는 다른 파일로 분리)
 * - stangerson-investigation.ts: 사건 조사 관련
 * - stangerson-lucy.ts: 루시 관련
 * - stangerson-location.ts: 위치/지하실/행동
 */
...
[셜록 홈즈]: "이상하군요. 집사라면 주인의 행방을 파악하고 계셔야 하는데, 3일이나 지났는데도 아무것도 모른다 말씀이신가요?"
...
[조셉 스탬거슨]: "저도... 상황을 이해하지 못하고 있습니다."`,
  ...
  stangerson_hub: {
    ...
    character: 'stangerson',
    speaker: 'watson',
    text: `스탠거슨이 불안하게 서 있다.

홈즈가 나를 본다. "왓슨, 무엇을 물어볼까?"

나는 생각한다. 아직 밝혀지지 않은 것들이 많다.`,
    choices: [
      { 
      ...
      { 
        text: '백작과의 관계를 캐묻는다', 
        nextNode: 'stangerson_relationship',
        hideIfVisitedNode: 'stangerson_relationship'
      },
      { 
        text: '끌려간 방향을 물어본다', 
        nextNode: 'stangerson_direction',
        hideIfVisitedNode: 'stangerson_direction'
      },
      { 
        text: '추궁한다', 
      ...
      { 
        text: '증거를 제시한다', 
        nextNode: 'present_evidence_to_stangerson'
      },
      {
        text: '🎯 "이제 진실을 말해주십시오"',
